<?php
/**
 * Plugin Name:Role Based Add To Cart/Price Hide For WooCommerce
...
define( 'WC_RBAP_NAME', __( 'Role Based Add To Cart/Price Hide For WooCommerce', 'wcrbap-hide' ) ); # Plugin Name
